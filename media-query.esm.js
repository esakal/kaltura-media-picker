...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$5 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor(O, P) {
  ...
  if (hasOwn$6(O, P)) return createPropertyDescriptor$1(!propertyIsEnumerableModule$1.f.call(O, P), O[P]);
};
...
var MediaQueryApi = /*#__PURE__*/function () {
  ...
  var _proto = MediaQueryApi.prototype;

  _proto._validateConfig = function _validateConfig() {
    if (!this._config.ks) {
  ...
  _proto._getKalturaServerUrl = function _getKalturaServerUrl() {
    return (this._config.serverUrl || defaultKalturaServerUrl) + "/?format=1";
  };

  _proto.getEntries = function getEntries(_ref) {
    var _this = this;
    ...
    return new Promise(function (resolve) {
      ...
      xhr.send(serialize(Object.assign(Object.assign({}, searchData), data)));
    });
  };
