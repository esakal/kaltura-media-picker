(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MediaQuery = {}));
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$9(fn = input.toString) && !isObject$6(val = fn.call(input))) return val;
	  if (isCallable$9(fn = input.valueOf) && !isObject$6(val = fn.call(input))) return val;
	  if (pref !== 'string' && isCallable$9(fn = input.toString) && !isObject$6(val = fn.call(input))) return val;
	...
	var setGlobal$3 = function (key, value) {
	  try {
	    ...
	    Object.defineProperty(global$f, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	    global$f[key] = value;
	  } return value;
	};
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$4 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$6(O, P)) return createPropertyDescriptor$1(!propertyIsEnumerableModule.f.call(O, P), O[P]);
	};
	...
	if (NATIVE_WEAK_MAP || shared.state) {
	  ...
	  set$1 = function (it, metadata) {
	    if (hasOwn$5(it, STATE)) throw new TypeError(OBJECT_ALREADY_INITIALIZED);
	    metadata.facade = it;
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$2(hiddenKeys$1, key) && hasOwn$2(O, key) && result.push(key);
	...
	***************************************************************************** */
	...
	var MediaQueryApi = function () {
	  ...
	  MediaQueryApi.prototype._validateConfig = function () {
	    if (!this._config.ks) {
	  ...
	  MediaQueryApi.prototype._getKalturaServerUrl = function () {
	    return (this._config.serverUrl || defaultKalturaServerUrl) + "/?format=1";
	  };

	  MediaQueryApi.prototype.getEntries = function (_a) {
	    var _this = this;
	    ...
	    return new Promise(function (resolve) {
	      var validationError = _this._validateConfig();
	      ...
	      var serverUrl = _this._getKalturaServerUrl();
	      ...
	      xhr.send(serialize(__assign(__assign({}, searchData), data)));
	    });
	  };

	  return MediaQueryApi;
	}();

	exports.MediaQueryApi = MediaQueryApi;
